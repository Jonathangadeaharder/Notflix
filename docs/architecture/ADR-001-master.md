...
**Decision:** We do **NOT** implement rate limiting. This is a local-first, single-machine platform. Rate limiting adds complexity without benefit for a non-public deployment. Defer to production readiness if the platform ever goes public.
