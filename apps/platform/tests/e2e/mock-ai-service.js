...
const FILTER_RESPONSE = {
  results: [
    [
      { text: "Hola", lemma: "hola", pos: "INTJ", is_stop: false, whitespace: " ", translation: null },
      { text: "mundo", lemma: "mundo", pos: "NOUN", is_stop: false, whitespace: "", translation: null },
    ],
    [
      { text: "Cómo", lemma: "cómo", pos: "ADV", is_stop: true, whitespace: " ", translation: null },
      { text: "estás", lemma: "estar", pos: "VERB", is_stop: false, whitespace: "", translation: null },
    ],
    [
      { text: "Muy", lemma: "muy", pos: "ADV", is_stop: true, whitespace: " ", translation: null },
      { text: "bien", lemma: "bien", pos: "ADV", is_stop: false, whitespace: " ", translation: null },
      { text: "gracias", lemma: "gracia", pos: "NOUN", is_stop: false, whitespace: "", translation: null },
    ],
  ],
};
...
async function handler(req, res) {
  ...
  if (method === "POST" && path === "/filter") {
    ...
    const results = texts.map((_, i) => FILTER_RESPONSE.results[i % FILTER_RESPONSE.results.length]);
  ...
  if (method === "POST" && path === "/translate") {
    const body = await readBody(req);
    const texts = body.texts || [];
    const translations = texts.map((_, i) => TRANSLATE_RESPONSE.translations[i % TRANSLATE_RESPONSE.translations.length]);
