...
describe('resolveUploadDir', () => {
  ...
  it('WhenAbsoluteLinuxPath_ThenReturnsAsIs', {
  ...
  it('WhenRelativePath_ThenResolvesAgainstCwd', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
...
describe('toAiServicePath', () => {
  ...
  it('WhenDocker_ThenExtractsFilenameAndPrefixesMediaRoot', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
  ...
  it('WhenDockerWithCustomMediaRoot_ThenUsesCustomRoot', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
    expect(
  ...
  it('WhenDockerWithCustomMediaRootTrailingSlash_ThenNoDoubleSlash', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
    expect(
      toAiServicePath('/local/path/audio.mp3', true, '/custom/media/'),
  ...
  it('WhenWindowsPathInDocker_ThenExtractsFilename', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
