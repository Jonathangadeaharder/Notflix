...
describe('redact', () => {
  it('WhenSensitiveKeyPresent_ThenRedactsValue', {
  ...
  it('WhenSensitiveKeyCaseInsensitive_ThenRedactsValue', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
    const result = redact({
      Password: 'x',
  ...
  it('WhenArrayValue_ThenRecursivelyRedacts', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
  ...
  it('WhenArrayWithNestedObjects_ThenRedactsAll', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
    const result = redact({
      data: [
  ...
  it('WhenNestedObject_ThenRecursivelyRedacts', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
    const result = redact({
  ...
  it('WhenNoSensitiveKeys_ThenPreservesAll', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
  ...
  it('WhenCompoundSensitiveKey_ThenRedactsValue', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
    const result = redact({
      accessToken: 'abc',
  ...
  it('WhenEmptyObject_ThenReturnsEmptyObject', {
    timeout: TEST_TIMEOUT_MS,
  }, () => {
    const result = redact({});
    expect(result).toEqual({});
