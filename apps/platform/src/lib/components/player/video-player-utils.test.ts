...
describe("formatTime", () => {
  it(
    "WhenZero_ThenReturnsZeroWithZeroSeconds",
  ...
  it(
    "When65Seconds_ThenReturnsOneColonZeroFive",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "When3661Seconds_ThenReturnsHourFormat",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenNaN_ThenReturnsZeroColonZeroZero",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenNegative_ThenReturnsZeroColonZeroZero",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenNegativeInfinity_ThenReturnsZeroColonZeroZero",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenPositiveInfinity_ThenReturnsZeroColonZeroZero",
    { timeout: TEST_TIMEOUT_MS },
    () => {
      expect(formatTime(Infinity)).toBe("0:00");
    },
  ...
  it(
    "WhenExactlyOneHour_ThenReturnsOneHourFormat",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "When59Seconds_ThenReturnsZeroColon59",
    { timeout: TEST_TIMEOUT_MS },
    () => {
...
describe("getMediaErrorMessage", () => {
  it(
    "WhenAbortedCode_ThenReturnsAbortedMessage",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenNetworkCode_ThenReturnsNetworkMessage",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenDecodeCode_ThenReturnsDecodeMessage",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenSrcNotSupportedCode_ThenReturnsSrcNotSupportedMessage",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenUnknownCode_ThenReturnsDefaultMessage",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenZeroCode_ThenReturnsDefaultMessage",
    { timeout: TEST_TIMEOUT_MS },
    () => {
...
describe("isAudioFile", () => {
  ...
  it(
    "WhenUpperCasedExtension_ThenReturnsTrue",
    { timeout: TEST_TIMEOUT_MS },
    () => {
      expect(isAudioFile("song.MP3")).toBe(true);
    },
...
describe("calculateNextInterrupt", () => {
  it(
    "WhenPositiveInterval_ThenMultipliesByChunkPlusOne",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenZeroInterval_ThenReturnsInfinity",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenNegativeInterval_ThenReturnsInfinity",
    { timeout: TEST_TIMEOUT_MS },
    () => {
...
describe("getTranscriptItemClass", () => {
  ...
  it(
    "WhenCurrentTimeInRange_ThenReturnsActiveClass",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenLearningClassification_ThenReturnsLearningClass",
    { timeout: TEST_TIMEOUT_MS },
    () => {
      expect(
  ...
  it(
    "WhenHardClassification_ThenReturnsHardClass",
    { timeout: TEST_TIMEOUT_MS },
    () => {
      expect(
  ...
  it(
    "WhenNoClassification_ThenReturnsDefaultClass",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenEasyClassification_ThenReturnsDefaultClass",
    { timeout: TEST_TIMEOUT_MS },
    () => {
      expect(
...
describe("shouldReportProgress", () => {
  it(
    "WhenFiveSecondsElapsed_ThenReturnsTrue",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenLessThanFiveSeconds_ThenReturnsFalse",
    { timeout: TEST_TIMEOUT_MS },
    () => {
  ...
  it(
    "WhenDurationNegative_ThenReturnsFalse",
    { timeout: TEST_TIMEOUT_MS },
    () => {
